...
function buildEmailHtml(fullName, code, purpose) {
...
async function sendViaConsole({ code, email, fullName }) {
    console.info(`[forgot-password] OTP for ${email} (${fullName}): ${code}`);
}
async function sendViaResend({ code, email, fullName, purpose }) {
...
async function sendResetOtpEmail(params) {
